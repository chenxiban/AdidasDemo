	...
	<body class="home">
		...
		<div id="page-wrapper">
										...
										<div class="mega-menu" data-col-lg="9" data-col-md="12">
											<div class="row">
												...
												<div class="col-md-3">
													...
													<p>生  而  好  动</p>
													<a href="ProductServlet?method=getProductByPages" class="btn btn-default btn-round">Go to Shop →</a>
												</div>
			...
			<script>
				...
				<input type="hidden" id="sid1" value="1">
			<div id="home-slider">
				<div class="flexslider" id="kucun2">
					<ul class="slides">
						<!-- THE FIRST SLIDE -->
						<li>
							<!-- THE MAIN IMAGE IN THE SLIDE -->
							<img src="images/home/main2.jpg" alt=""/>

							<!-- THE CAPTIONS OF THE FIRST SLIDE -->
							<div class="flex-caption h6 text-bold gfc uppercase animated" data-animation="fadeInLeftBig" data-x="1000" data-y="300" data-speed="600" data-start="1200">时尚新品</div>

							<div class="flex-caption herotext text-bold gfc animated" data-animation="fadeInRightBig" data-x="800" data-y="305" data-speed="900" data-start="2000">adidas neo</div>

							<div class="flex-caption h6 text-bold gfc text-center animated" data-animation="fadeInLeftBig" data-x="1200" data-y="350" data-speed="1600" data-start="2900">
								<a href="products.jsp" class="btn btn-primary uppercase">立即选购</a>
							</div>
						...
						<li>
							<!-- THE MAIN IMAGE IN THE SLIDE -->
							<img src="images/home/main_1.jpg" alt="" />
						...
						<li>
							<!-- THE MAIN IMAGE IN THE SLIDE -->
							<img src="images/home/main_3.jpg" alt="" />
				...
				<section class="section promos">
					<div class="container">
						<div class="row" id="guanggao">
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z1.jpg') no-repeat; background-size: 100% 100%;">
									<div class="inner text-center np">
										<div class="ribbon">
											<h5 class="text-semibold uppercase nmb">由我创造</h5>
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z2.jpg') no-repeat; background-size: 100% 100%;">
									<div class="inner text-center np">
										<div class="ribbon">
											<h5 class="text-semibold uppercase nmb">燃 到底</h5>
											<div class="space10"></div>
											<a href="products.jsp" class="with-icon prepend-icon"><i class="iconfont-caret-right"></i><span> Shop Now</span></a>
										</div>
									</div>
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z3.jpg') no-repeat; background-size: 100% 100%;">
									<div class="inner text-center np">
										<div class="ribbon">
											<h5 class="text-semibold uppercase nmb">HERE TO CREATE</h5>
											<div class="space10"></div>
											<a href="products.jsp" class="with-icon prepend-icon"><i class="iconfont-caret-right"></i><span> Shop Now</span></a>
										</div>
									</div>
