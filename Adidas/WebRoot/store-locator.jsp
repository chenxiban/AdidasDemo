...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML PUBLIC "-//IETF//DTD HTML//EN" 4.01 Transitional//EN">
							...
							<section class="sidebar m-t-b">
								<section class="side-section">
									...
									<ul class="nav nav-tabs nav-stacked">
										<li>
											<a href="index-3.jsp">Homepage</a>
										</li>
										<li>
											<a href="about-us.jsp">About us</a>
										</li>
										<li>
											<a href="products-2.jsp">Shop</a>
										</li>
										<li>
											<a href="product-2.jsp">Single Product Details</a>
										</li>
										<li>
											<a href="contact-us-2.jsp">Contact us</a>
										</li>
									</ul>
								</section>
