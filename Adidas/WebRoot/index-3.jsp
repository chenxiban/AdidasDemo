			...
			<div id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							<!-- THE MAIN IMAGE IN THE SLIDE -->
							<img src="images/home/main_6.jpg" alt="" />
				...
				<section class="section promos">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z7.jpg') no-repeat; background-size: 100% 100%;">
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z8.jpg') no-repeat; background-size: 100% 100%;">
									<div class="inner text-center np">
										<div class="ribbon">
							...
							<div class="col-md-4">
								<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('images/home/z9.jpg') no-repeat; background-size: 100% 100%;">
									<div class="inner text-center np">
										<div class="ribbon">
